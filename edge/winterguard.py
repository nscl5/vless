...
def main():
    try:
        ...
        # Remove the internal proxies key from dictionary so we dump it manually from text block
        if "proxies" in config_template_dict:
            del config_template_dict["proxies"]
        ...
        try:
            ...
            # 1. Dump everything except proxies list
            base_yaml_output = yaml.dump(
            ...
            # 2. Safely reconstruct the final config layout inserting the literal proxy block
